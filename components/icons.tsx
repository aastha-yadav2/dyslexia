...
export const HighContrastIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
  </svg>
);

export const FontIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m-4-16v16m8-16v16M4 8h16m-4 8h-8" />
  </svg>
);

export const FocusIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5v-4m0 4h-4m4 0l-5-5" />
  </svg>
);

export const LineSpacingIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const GoogleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 48 48">
    ...
    <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-0.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.245 44 30.028 44 24c0-1.341-.138-2.65-.389-3.917z"></path>
  </svg>
);

export const AdjustmentsHorizontalIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8v-2m0 2a2 2 0 100 4m0-4a2 2 0 110 4m0-4v-2m0 2h12m-12 0v-2m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6-8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-2h12m0 0v-2m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6-8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-2h12" />
  </svg>
);
...
export const TwitterIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M22.46 6c-.77.35-1.6.58-2.46.67.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98-3.56-.18-6.72-1.89-8.84-4.48-.37.63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.58-.7-.02-1.37-.22-1.95-.55v.05c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.98 8.52 8.52 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.23z" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M5 11a7 7 0 007 7 7 7 0 007-7M5 11v2a7 7 0 0014 0v-2M5 11H3m2 10h14" />
  </svg>
);

export const UsersIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.28-1.259-.75-1.685M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.28-1.259.75-1.685M12 12a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
export const RecordCircleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
...
export const ArrowRightLeftIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const DocumentArrowUpIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11V7m0 0L9.5 9.5M12 7l2.5 2.5" />
  </svg>
);
...
export const SigningAvatarIcon: React.FC<IconProps> = ({ className = "w-24 h-24" }) => (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="32" cy="16" r="8" fill="currentColor" fillOpacity="0.3"/>
        <path d="M44 32C44 25.3726 38.6274 20 32 20C25.3726 20 20 25.3726 20 32V44H44V32Z" fill="currentColor" fillOpacity="0.3"/>
        <path d="M22 46C18.6863 46 16 43.3137 16 40C16 36.6863 18.6863 34 22 34" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M42 46C45.3137 46 48 43.3137 48 40C48 36.6863 45.3137 34 42 34" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);

export const HandIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ShieldCheckIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.955a11.955 11.955 0 0018 0a12.02 12.02 0 00-3.382-9.016z" />
  </svg>
);

export const SparklesIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.5 17.5l-1.5 1.5M18.5 5.5l1.5-1.5M12 2v2m0 16v2m-6.5-2.5l-1.5 1.5M18.5 15.5l1.5 1.5M10 12l-2 2 2 2m4-4l2-2-2-2" />
  </svg>
);
...
export const RedditIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.02,2.51c-3.5,0-6.35,2.85-6.35,6.35c0,1.96,0.9,3.71,2.29,4.88l-2.43,5.25c-0.1,0.22,0.02,0.48,0.24,0.58c0.22,0.1,0.48-0.02,0.58-0.24l2.43-5.25c0.55,0.15,1.12,0.23,1.72,0.23s1.17-0.08,1.72-0.23l2.43,5.25c0.1,0.22,0.36,0.33,0.58,0.24c0.22-0.1,0.33-0.36,0.24-0.58l-2.43-5.25c1.4-1.17,2.29-2.92,2.29-4.88C18.37,5.36,15.52,2.51,12.02,2.51z M12.02,12.44c-1.85,0-3.35-1.5-3.35-3.35S10.17,5.74,12.02,5.74s3.35,1.5,3.35,3.35S13.87,12.44,12.02,12.44z"/><path d="M22.49,13.79c-0.42-0.21-0.92-0.04-1.13,0.38c-0.61,1.23-1.49,2.26-2.56,3.02c-1.39,0.99-3.1,1.55-4.89,1.55c-1.79,0-3.5-0.56-4.89-1.55c-1.07-0.77-1.95-1.8-2.56-3.02c-0.21-0.42-0.71-0.59-1.13-0.38c-0.42,0.21-0.59,0.71-0.38,1.13c0.7,1.39,1.69,2.58,2.94,3.46c1.55,1.11,3.45,1.73,5.46,1.73c2.01,0,3.91-0.62,5.46-1.73c1.25-0.89,2.24-2.07,2.94-3.46C23.08,14.5,22.91,14,22.49,13.79z"/>
    </svg>
);
...
export const BrainIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.245 4.5 4.5 0 008.9-2.245c0-.142-.023-.285-.067-.426a2.25 2.25 0 014.286-1.954 2.25 2.25 0 012.4 2.245 3 3 0 10-5.78-1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 00-8.9 2.245c0 .142.023.285.067.426a2.25 2.25 0 01-4.286 1.954 2.25 2.25 0 01-2.4-2.245 3 3 0 005.78 1.128 2.25 2.25 0 012.4-2.245z" />
    </svg>
);
